package me.marufsharia.qiblacompass;
...
public class CompassActivity extends AppCompatActivity {
    ...
    private TextView tvYourLocationPlace;
    //public Menu menu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        geocoder = new Geocoder(CompassActivity.this, Locale.getDefault());
        //////////////////////////////////////////
        ...
        tvYourLocationPlace = findViewById(R.id.your_location_place);
    ...
    private void setupCompass() {
        ...
        if (permission_granted) {
            ...
            tvYourLocationPlace.setText(getResources().getString(R.string.msg_permission_not_granted_yet));
    ...
    public void getBearing() {
        ...
        if (kaabaDegs > 0.0001) {
            ...
            String fullAddress = getFullAddess(gps.getLocation().getLatitude(),gps.getLocation().getLongitude());
            tvYourLocationPlace.setText(fullAddress);
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == RC_Permission) {
            ...
            if (grantResults.length > 0
                ...
                tvYourLocationPlace.setText(getResources().getString(R.string.msg_permission_granted));
                qiblatIndicator.setVisibility(INVISIBLE);
                qiblatIndicator.setVisibility(View.GONE);
   ...
   /* public void Savelong(String Judul, Long bbb) {
    ...
    public void fetch_GPS() {
        ...
        if (gps.canGetLocation()) {
            ...
            if (myLat < 0.001 && myLng < 0.001) {
                ...
                tvYourLocationPlace.setText(getResources().getString(R.string.location_not_ready));
                /*if (item != null) {
                    item.setIcon(ContextCompat.getDrawable(getApplicationContext(), R.drawable.gps_off));
                }*/
            ...
            tvYourLocationPlace.setText(getResources().getString(R.string.pls_enable_location));
            /*if (item != null) {
                item.setIcon(ContextCompat.getDrawable(getApplicationContext(), R.drawable.gps_off));
            }*/
    ...
    public String getFullAddess(double latitude,double longitude)
    {
